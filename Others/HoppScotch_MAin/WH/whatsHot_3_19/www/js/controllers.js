angular.module('slider.controllers', ['ngTouch', 'ionic'])
.controller('StartCtrl', function ($scope, $rootScope,$ionicLoading,$cordovaGeolocation, $state, $timeout, $famous){
    ...
    $scope.animate = function() {
      console.log('animate');
        ...
        $scope.fbTransition.set(     [100, 405, 0], {duration: 1000, curve: Easing.outExpo})
        $scope.twTransition.set(     [-100, 405, 0], {duration: 1000, curve: Easing.outExpo})
