...
.controller('Slide1Ctrl', function ($scope, $rootScope, $cordovaGeolocation, $state, $timeout, $famous){
    ...
    $scope.textTransition = new Transitionable([0,-100,0]);
    ...
    $scope.swipeLeft = function () {
       ...
       $scope.imageTransition = new Transitionable([0, 200, 0]);
        ...
        $scope.animateOut = function() {
          ...
          $scope.textTransition.set([0, 900, 0], {duration: 2000, curve: Easing.outExpo})
          $scope.imageTransition.set([0, 900, 0], {duration: 2000, curve: Easing.outElastic})
        };
       $scope.animateOut();
       $timeout(function () {
          $state.go('slide2');
