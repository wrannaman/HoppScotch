...
.controller('StartCtrl', function ($scope, $rootScope,$ionicLoading,$cordovaGeolocation, $state, $timeout, $famous){
    ...
    $scope.animate = function() {
      console.log('animate');
        ...
        $scope.button2Transition.set([0, 600, 0], {duration: 1000, curve: Easing.outExpo})
        $scope.button3Transition.set([0, 600, 0], {duration: 1000, curve: Easing.outExpo})
        $scope.button2Transition.set([-100, 400, 0], {duration: 1000, curve: Easing.outExpo})
        $scope.button3Transition.set([100, 400, 0], {duration: 1000, curve: Easing.outExpo})
...
.controller('ChatCtrl', function ($scope,$rootScope,$state,$cordovaGeolocation,$ionicModal, $ionicLoading, $http, $rootScope, $timeout, $famous){
    ...
    $scope.getMessage = function () {  
      ...
      $http.get('http://192.168.1.122:3000/getMessages')
       .success(function(data,status,header,config){
          $scope.messageArray = [];
           console.log('***express***');
           console.log(data, status, header, config);
    ...
    $scope.postMessage = function () {
     ...
     if (message.length > 144) {
      ...
      $ionicLoading.show();
           ...
           $http.post('http://192.168.1.122:3000/setMessage', {"message": safeMessage, "id": "100", "points": 0})
           .success(function(data,status,header,config) {
               console.log('***post success***');
               console.log(data, status, header, config);
               console.log('***post success***');
