...
.controller('Lesson3Ctrl', function ($scope, $famous){
    ...
    $scope.list = [
        {content:"You know when", bgColor: "#b58900", rotate: new Transitionable(0), method: 'spring'},
        {content:"You're like", bgColor: "#cb4b16", rotate: new Transitionable(0)},
        {content: "'Hey, wanna do something tonight?'", bgColor: "#dc322f", rotate: new Transitionable(0)},
        {content: "but you want to make sure", bgColor: "#d33682", rotate: new Transitionable(0)},
        {content: "before you get there", bgColor: "#6c71c4", rotate: new Transitionable(0)},
        {content: "that it's going to be cool?", bgColor: "#268bd2", rotate: new Transitionable(0)}
    ];

    $scope.animate = function() {
        for (var i = 0; i < $scope.list.length; i++) {
            $scope.list[i].rotate.set(Math.PI * 4, {curve: Easing.inOutElastic, duration: 9000 * i})
        };
    };
