angular.module('slider.controllers', ['ngTouch', 'ionic', 'ngResource','ngCordovaOauth'])

.controller('StartCtrl', function ($scope, $rootScope,$ionicPlatform, $ionicLoading,$cordovaGeolocation,$cordovaOauth,$cordovaOauthUtility, $state, $timeout, $famous) {
    ...
    $scope.animate = function() {
      console.log('animate');
        ...
        $scope.button2Transition.set([0, 370, 0], {duration: 1000, curve: Easing.outExpo})
        $scope.button3Transition.set([0, 390, 0], {duration: 1000, curve: Easing.outExpo})
        $scope.button2Transition.set([-100, 500, 0], {duration: 1000, curve: Easing.outExpo})
